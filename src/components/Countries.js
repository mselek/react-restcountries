...
const Countries = () => {
    ...
    useEffect(() => {
        ...
        {
            axios
            .get('https://restcountries.com/v2/all?fields=name,population,region,capital,flags')
            .then((res) => setData(res.data));
            setPlayOne(false);
        }

        // trier les pays selon nb de population
        const sortedCountry = () => {
        ...
        <div className="countries">
            <div className="sort-container">
                ...
                <div className="cancel">
                    {selectedRadio && <h5 onClick={() => setSelectedRadio('')}>X</h5>}
                </div>
            </div>
            <ul className="coutries-list">
                {sortedData
